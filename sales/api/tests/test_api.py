...
class Tests(TransactionTestCase):
    ...
    def test_sales_people_list(self):
        ...
        self.assertEqual(
            ...
            200,
            msg="Did not get a 200 OK for list salespeople."
        )
        self.assertTrue(
            'salespeople' in data,
            msg="Did not give response with salespeople field."
        )
        self.assertEqual(
            len(data['salespeople']),
            1,
    ...
    def test_sales_people_delete(self):
        ...
        self.assertEqual(
            response.status_code,
            200,
            msg="Did not get a 200 OK for salespeople delete."
        )
        ...
        self.assertEqual(
            response.status_code,
            404,
            msg="Did not get a 404 OK salespeople delete of an unknown id."
        )
    ...
    def test_customer_list(self):
        ...
        self.assertEqual(
            response.status_code,
            200,
            msg="Did not get a 200 OK for list customer."
        )
        self.assertTrue(
            'customers' in data,
            msg="Did not give response with customer field."
        )
        self.assertEqual(
            len(data['customers']),
            1,
            msg="Did not return correct number of customer."
        )
    ...
    def test_customer_delete(self):
        ...
        self.assertEqual(
            response.status_code,
            200,
            msg="Did not get a 200 OK for customer delete."
        )
        ...
        self.assertEqual(
            response.status_code,
            404,
            msg="Did not get a 404 OK customer delete of an unknown id."
        )
    ...
    def test_sales_list(self):
        ...
        self.assertEqual(
            response.status_code,
            200,
            msg="Did not get a 200 OK for list sales."
        )
        self.assertTrue(
            'sales' in data,
            msg="Did not give response with sales field."
        )
        self.assertEqual(
            len(data['sales']),
            1,
            msg="Did not return correct number of sales."
        )
    ...
    def test_sales_create(self):
        ...
        response = client.post(
            "/api/sales/",
            json.dumps({**body, "automobile": 999}),
            content_type='application/json'
        )
        data = response.json()
        self.assertTrue(
            response.status_code == 404 or response.status_code == 400,
            msg="Did not get a 404 OK for non-existent auto/"
        )

        response = client.post(
            "/api/sales/",
            json.dumps({**body, "salesperson": 999}),
            content_type='application/json'
        )
        data = response.json()
        self.assertTrue(
            response.status_code == 404 or response.status_code == 400,
            msg="Did not get a 404 OK for non-existent salesperson/"
        )

        response = client.post(
            "/api/sales/",
            json.dumps({**body, "customer": 999}),
            content_type='application/json'
        )
        data = response.json()
        self.assertTrue(
            response.status_code == 404 or response.status_code == 400,
            msg="Did not get a 404 OK for non-existent customer/"
        )
    ...
    def test_sale_delete(self):
        ...
        self.assertEqual(
            response.status_code,
            200,
            msg="Did not get a 200 OK for sales delete."
        )

        response = client.delete(f"/api/sales/{sale.id}/")
        self.assertTrue(
            response.status_code == 404 or response.status_code == 400,
            msg="Did not get a 404 OK sales delete of an unknown id."
        )
